...
public class Bbb1Activity extends AppCompatActivity {
    private TextView textView;
    private Button btnGetPic;
    private ImageView imageView;
    private ProgressBar pb;
    final String urlStry="http://192.168.43.222:8080/TestServer/pic/qita.jpg";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(com.example.phonewallet11.R.layout.activity_bbb1);
        //  获取组件对象
        ...
        btnGetPic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //第1种方法：使用AsyncTask+OkHttp的同步请求方式 结果发送给主线程，从而在主线程中更新
                //第2种方法：使用OkHttp的异步请求方式+Handler或runOnUiThread（）
                new DownloadTask().execute(urlStry);
    ...
    class DownloadTask extends AsyncTask<String, Integer, Bitmap> {
        ...
        protected void onProgressUpdate(Integer... values) {
            ...
            textView.setText("正在下载"+values[0]+"%");
