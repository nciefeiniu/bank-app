...
public class Abb1Activity extends AppCompatActivity {
    private TextView textView;
    private Button btnGetPic;
    private ImageView imageView;
    private ProgressBar pb;
    final String urlStr1="http://192.168.43.222:8080/TestServer/pic/bamboo1.jpg";
    final String urlStr2="http://192.168.43.222:8080/TestServer/pic/Qita.jpg";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGetPic = findViewById(R.id.button);
